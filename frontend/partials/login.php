...
<head>
    ...
    <style>
        ...
        .btn-restoran { background-color: #e74c3c; color: white; border: none; }
        .btn-restoran:hover { background-color: #c0392b; color: white; }
        .nav-pills .nav-link.active { background-color: #e74c3c; color: white; }
...
<div class="card shadow-lg border-0 rounded-4 p-4" style="width: 100%; max-width: 420px;">
    <div class="text-center mb-3">
        ...
        <p class="text-muted small">Selamat Datang Pelanggan Setia</p>
    </div>
